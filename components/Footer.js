  ...
  return (
    <div className="large-container p-4 sm:py-16 py-8 flex sm:justify-between flex-col sm:flex-row sm:items-center items-start space-y-2 sm:space-y-0">
      ...
      <div className="flex sm:space-x-8 flex-col sm:flex-row items-start space-y-2 sm:space-y-0">
        <Link href="">
          <a className="p-2 hover:bg-gray-100 dark:hover:bg-blackish2 text-gray-900 dark:text-gray-500 hover:text-blue-700 dark:hover:text-blue-500 rounded-full transition-all flex space-x-3 items-center font-semibold">
            <svg
        ...
        <Link href="">
          <a
            ...
            className="p-2 hover:bg-gray-100 dark:hover:bg-blackish2 text-gray-900 dark:text-gray-500 hover:text-blue-700 dark:hover:text-blue-500 rounded-full transition-all flex space-x-3 items-center font-semibold"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
